...
const DESCRIPTORS: Record<string, string> = {
  ...
  ZYN: 'ZYN is the world’s best-known tobacco-free nicotine pouch brand, with flavours from Cool Mint and Wintergreen to Coffee and Cinnamon across 6mg–16.5mg strengths.',

...
export const metadata: Metadata = {
  ...
  description: 'Track your Aussie Vape order and find your tracking number.',
}
  ...
  return (
    <InfoPage title="Order Tracking" intro="Keep an eye on your delivery from dispatch to doorstep.">
      <Section heading="Find Your Tracking Number">
        <p>When your order ships, we email you a tracking number and a link to the carrier&apos;s tracking page. Check your inbox (and spam folder) for an email from Aussie Vape.</p>
      </Section>

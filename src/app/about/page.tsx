...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn about Aussie Vapes — an Australian-owned online vape retailer focused on fast dispatch and customer service.',
}

export default function AboutPage() {
  return (
    <InfoPage
      title="About Aussie Vapes"
    ...
    >
      <Section heading="Who We Are">
        <p>Aussie Vapes is a Melbourne-based retailer supplying disposables, pod systems, e-liquids, and accessories to adult customers across Australia. We focus on a curated range from the brands customers actually ask for.</p>
      </Section>
